#！/usr/bin/env python
#_*_conding:utf-8_*_
# @Time    : 2019/1/24 0024 上午 11:30
# @Author  : 蜜蜜
# @Email   : 1402686685@qq.com
# @File    : js处理日历控件.py
'''
1、日历控件是web网站上经常会遇到的一个场景，有些输入框是可以直接输入日期的，有些不能，
以我们经常抢票的12306网站为例，详细讲解如何解决日历控件为readonly属性的问题。
2、基本思路：先用js去掉readonly属性，然后直接输入日期文本内容'''
